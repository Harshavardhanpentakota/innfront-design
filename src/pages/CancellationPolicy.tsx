...
const CancellationPolicy = () => {
  const policySchema = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://abhitejinn.com/cancellation-policy",
        "url": "https://abhitejinn.com/cancellation-policy",
        "name": "Cancellation & Refund Policy | Hotel Abhitej INN Araku",
        "description": "Read the reservation cancellation guidelines, refunds percentages, and deadlines for bookings at Hotel Abhitej INN Araku.",
        "breadcrumb": {
          "@type": "BreadcrumbList",
          "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://abhitejinn.com/" },
            { "@type": "ListItem", "position": 2, "name": "Cancellation Policy", "item": "https://abhitejinn.com/cancellation-policy" }
          ]
        }
      }
    ]
  ...
  return (
    <PageLayout>
      <SEO
        title="Cancellation & Refund Policy | Hotel Abhitej INN Araku"
        description="View room booking cancellation deadlines and refund structures at Hotel Abhitej INN. Learn how to cancel and get 100% refund up to 48 hours prior."
        schema={policySchema}
      />
      ...
      <section className="container-page py-12 max-w-3xl">
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-soft space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-4 rounded-xl border border-green-200 bg-green-50 p-4 dark:border-green-900 dark:bg-green-950/30">
                ...
                <div>
                  <h3 className="font-semibold text-sm">Full Refund</h3>
              ...
              <div className="flex items-start gap-4 rounded-xl border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-900 dark:bg-yellow-950/30">
                ...
                <div>
                  <h3 className="font-semibold text-sm">Partial Refund</h3>
              ...
              <div className="flex items-start gap-4 rounded-xl border border-red-200 bg-red-50 p-4 dark:border-red-900 dark:bg-red-950/30">
                ...
                <div>
                  <h3 className="font-semibold text-sm">No Refund</h3>
        ...
        <p className="text-xs text-muted-foreground text-center mt-6">
          Last updated: June 2026 · Reviewed by Hotel Abhitej INN Editorial Team
        </p>
      </section>
    </PageLayout>
  );
